...
//
// 13.04.2000 Florian Xaver changes:
//
...
#define TXT_TITEL               INI_TEXT("CompactDisc Player v1.1 - drive %c:")
#define TXT_CDPLAYER            INI_TEXT("CompactDisc Player v1.1")
...
#define TXT_REWIND              INI_TEXT("Rewind (~4 second)")
#define TXT_FORWARD             INI_TEXT("Forward (~4 second)")
...
#define TXT_PLAYBACKGROUND      INI_TEXT("Closes cd player without stoping")
...
void  trackinfo_draw ( p_view o )
{
  ...
  if ( out ) {
    ...
    if (cd_track_pause == 0)
           ...
           about = set_format_text(NULL, "[song %i/%i] " TXT_PAUSE, cd_track, bcd_get_audio_info());
...
p_object  get_button ( t_rect r, l_text str, l_dword msg, l_int flags, l_text i_t) {
...
void  init_cdplayer ( void )
{
   ...
   t_rect r = rect_assign(0, 0, 520, 100);
   t_rect t = r;
   ...
   r = rect_assign(r.a.x+10, r.a.y+10, r.a.x+300, r.a.y+65);
   ...
   OBJECT(o)->insert(OBJECT(o), get_button(r, "b", MSG_PLAY, BF_NORMAL, TXT_PLAY)); /* insert button to window ...see get_button function under this function */

   r = rect_assign(r.b.x+4, r.a.y, r.b.x+34, r.a.y+25); /* play at background button */

   OBJECT(o)->insert(OBJECT(o), get_button(r, "M", MSG_PLAYATBACKGROUND, BF_NORMAL, TXT_PLAYBACKGROUND)); /* insert button to window ...see get_button function under this function */
   ...
   OBJECT(o)->insert(OBJECT(o), get_button(r, "W", MSG_STOP, BF_NORMAL, TXT_STOP)); /* insert button to window ...see get_button function under this function */
   ...
   r = rect_assign(r.b.x+4, r.a.y, r.b.x+34, r.b.y); /* /\ button */
   OBJECT(o)->insert(OBJECT(o), get_button(r, "d", MSG_OUT, BF_NORMAL, TXT_OPEN_CLOSE)); /* insert button to window ...see get_button function under this function */

   r = rect_assign(r.b.x+4, r.a.y, r.b.x+34, r.b.y); /* time button */
   button = BUTTON(get_button(r, "T", MSG_TIME, BF_NORMAL, TXT_TIME));
   VIEW(button)->font = get_font_in_size("ActiveCE", 16, 16);
   ...
   button = BUTTON(get_button(r, "D", MSG_DRIVE, BF_NORMAL, TXT_DRIVE));
   VIEW(button)->font = get_font_in_size("ActiveCE", 16, 16);   
   OBJECT(o)->insert(OBJECT(o), OBJECT(button)); /* insert button to window ...see get_button function under this function */
};
