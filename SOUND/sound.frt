...
AddAssoc=List by funktions,Funktion,90
AddAssoc=List by prototype,Prototype,500
...
#
# Title of the HTML
Constant="Sound Player Api documentation"

# Description for the help
Constant="This document describes the functions of my library.
It                   is                   created                   with
@<link>{http://members.xoom.com/stropea/setedit.html,SET-Editor}     from
@<link>{dlxsound.c,dlxsound.c}. For developers: please use SDG to update
the documentation from the source
@p
Copyright(c)
@<mailto>{florianx@drdos.org,Florian Xaver} 2000"
